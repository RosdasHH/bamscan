...
Future<bool> addQrCodeReq(BuildContext context, Spool spool, String? qrid) async {
...
Future<bool> addNfcIdReq(BuildContext context, Spool spool, String? nfcid) async {
  final availableFilaments = context.read<AvailableFilaments>();
  String newNotes = spool.note ?? "";
  if (nfcid != null) {
