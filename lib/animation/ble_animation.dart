...
class BleAnimation extends StatefulWidget {
  const BleAnimation({super.key});

  @override
  State<BleAnimation> createState() => _BleAnimationState();
}

class _BleAnimationState extends State<BleAnimation> with SingleTickerProviderStateMixin {
  ...
  Widget _core() {
    return Container(
      ...
      child: const Icon(Icons.bluetooth, size: 44, color: Colors.blue),
    );
  }
